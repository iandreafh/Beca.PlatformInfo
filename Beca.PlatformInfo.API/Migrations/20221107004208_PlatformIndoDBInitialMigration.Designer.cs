...
namespace Beca.PlatformInfo.API.Migrations
{
    ...
    [Migration("20221107004208_PlatformIndoDBInitialMigration")]
    partial class PlatformIndoDBInitialMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlatformInfo.API.Entities.Movie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PlatformInfo.API.Entities.Platform", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PlatformInfo.API.Entities.Movie", b =>
                {
                    b.HasOne("PlatformInfo.API.Entities.Platform", "Platform")
                        .WithMany("Movies")
